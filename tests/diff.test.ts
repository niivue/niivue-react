...
test("diffList", () => {
  const before = {
    wmLeft: {
      ...
      opacity: 0.5,
      layers: {
        thickness: { url: "https://example.com/lh.cortical_thickness.mz3" },
        curvature: { url: "https://example.com/lh.wm.curvature.mz3" },
      },
    },
    wmRight: {
      url: "https://example.com/rh.wm.mz3",
      opacity: 0.5,
      layers: {
        thickness: { url: "https://example.com/rh.cortical_thickness.mz3" },
        curvature: { url: "https://example.com/rh.wm.curvature.mz3" },
      },
    },
    gm: {
      url: "https://example.com/gm.mz3",
      opacity: 0.5,
      layers: { curvature: { url: "https://example.com/gm.curvature.mz3" } },
    },
    pial: {
      url: "https://example.com/pial.mz3",
      opacity: 0.0,
      layers: { curvature: { url: "https://example.com/pial.curvature.mz3" } },
    },
    hippo: {
  ...
  const after = {
    ...
    wmLeft: {
      ...
      layers: {
        thickness: { url: "https://example.com/lh.cortical_thickness.mz3" },
        curvature: {
          url: "https://example.com/lh.wm.curvature.mz3",
          opacity: 0.0,
        },
      },
    },
    ...
    gm: {
      ...
      opacity: 0.5,
      layers: {
        curvature: { url: "https://example.com/gm.curvature.mz3" },
        sulcal_depth: {
          url: "https://example.com/sulcal_depth.mz3",
          colormap: "jet",
        },
      },
    },
  ...
  expectedChanged.forEach((expected) =>
    expect(actual.changed).toContainEqual(expected),
  );
...
test("diff should return {} when object not changed", () => {
  const layers = {
    thickness: { url: "https://example.com/cortical_thickness.mz3" },
    curvature: { url: "https://example.com/curvature.mz3" },
  };
...
test.each([
  [
    ...
    {
      name: "wm",
      layers: { curvature: { url: "https://example.com/curvature.mz3" } },
    },
  ...
  "diff(%o, %o)  // should be IRRECONCILABLE because %s",
  (x: object, y: object, _comment) => {
...
test.each([
  [
    {
      ...
      layers: {
        thickness: {
          url: "https://example.com/cortical_thickness.mz3",
          colorbarVisible: true,
        },
        curvature: {
          url: "https://example.com/curvature.mz3",
          colorbarVisible: true,
        },
      },
    },
  ...
  "diff(%o, %o)  // should return changed properties of layers",
  (x: object, y: object, expected: object, _comment) => {
...
const DIFF_PRIMITIVE_TEST_CASES: [object, object, object, string][] = [
  ...
  [
    { flavor: "salty", pH: 6.2 },
    { flavor: "sweet", sauce: "bbq" },
    { flavor: "sweet", sauce: "bbq", pH: undefined },
    'changed "flavor", added "sauce", removed "pH"',
  ],
  [
...
test.each(DIFF_PRIMITIVE_TEST_CASES)(
  "diffPrimitive(%o, %o) -> %o  // %s",
  (x, y, expected, _comment) => {
